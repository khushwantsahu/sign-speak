...
3. Synthesize the sub-agent's response into a supportive, clear reply.
   CRITICAL: You MUST include the full detailed response generated by the specialist sub-agent (including all step-by-step descriptions, mnemonics, and markdown visual reference image tags) in your final response. Never omit, truncate, or summarize away the specific instructions or visual diagrams returned by the tools.
